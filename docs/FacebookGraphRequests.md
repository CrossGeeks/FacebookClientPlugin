...
Response is type FacebookResponse<string> which includes the string of the raw facebook response if succesfull. If not Data value will be null, and should have a value on Message property with the error.
